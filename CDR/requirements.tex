...
Temperature & $-7^{\circ} \,C$ & $22^{\circ} \,C$ & worst-case $10-90$ percentile band\\
Wind speed & $1\;/\;3 \,m/s$ & $6\;/\;(9) \,m/s$ & Daily average / worst-case $10-90$ percentile band). Usually from the south west\\
Probability of precipitation & $61\%$ & $63\%$ & Daily average. Mostly light rain/snow or moderate rain/snow\\
Cloud cover & $83\%$ & $85\%$ & Median cloud cover(mostly cloudy)\\
Solar incidence angle & $46^{\circ}$ & $57^{\circ}$ & See Section \ref{subsec:environmental_requirements}\\
\hline
\end{tabularx}}
\end{table}
