...
\makebox[\textwidth]{
\begin{tabularx}{1.06\textwidth}{p{0.35\textwidth} p{0.15\textwidth} p{0.15\textwidth} p{0.35\textwidth}}
\hline
...
Solar incidence angle at noon & 46 $^\circ$ & 46 $^\circ$ & Refer to document \newline USPACE-PDR-PWR-A1\\
\hline
\end{tabularx}}
\end{table}
