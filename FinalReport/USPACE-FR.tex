...
\def\docreference{USPACE-FR-A1}	% -00 = DRAFT,  -A1 = 1st release,  -A2 = 1st release with minor updates, -B1, = 2nd release
...
\input{normative_references_change_record}
\include{acronyms}
