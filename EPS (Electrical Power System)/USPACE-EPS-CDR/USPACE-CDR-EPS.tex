...
\usepackage{url}
\usepackage{acronym}
\usepackage{rotating} % allow sideways figures and tables
\usepackage{titling}
\usepackage{bibcheck}
%\usepackage{pdfpages}
\usepackage[pdfstartview=FitH,pdfborder={0 0 0},bookmarks]{hyperref} % activate cross links in pdf
\usepackage{memhfixc}
...
\def\docreference{USPACE-CDR-EPS-A1}	% -00 = DRAFT,  -A1 = 1st release,  -A2 = 1st release with minor updates, -B1, = 2nd release
